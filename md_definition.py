...
def md_main(args):
    ...
    if args.mode!="10fold":
        dev_dataset = mytestdataset(data_preprocess(load(args.dev_path)))
        dev_loader = util_data.DataLoader(dev_dataset, batch_size=args.batch_size, shuffle=False, num_workers=0)
    test_dataset = mytestdataset(data_preprocess(load(args.test_path)))
...
if __name__=="__main__":
    ...
    parser.add_argument('--mode', default="", type=str, help='if 10fold')
